...
@Tags({"whq", "test"})
public class NifiTest extends AbstractProcessor {
    //外界参数说明
        ...
        try {
            ...
            flowFile=session.write(flowFile,(in,out)->{
                try(final InputStream inrow=new BufferedInputStream(in);
                    ...
                    System.out.println(tableName+"  "+new String(IOUtils.toByteArray(inrow), Charset.forName("utf8")));
                    outrow.write(("读完写测试"+tableName).getBytes());
                }
            });
